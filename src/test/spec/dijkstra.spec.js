define(["modules/dijkstra"], function (Dijkstra) {

  console.log("no");
  describe("MinHeap PQ Dijkstra Single-Source Shortest Paths", function () {
    ...
    it("should find the correct shortest path distances", function () {
      var distances = Dijkstra.run(graph, graph.V[0]);
      expect(distances).toEqual(graph.D);
    });
